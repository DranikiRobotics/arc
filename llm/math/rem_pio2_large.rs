...
const PIO2: [Float64; 8] = [
    1.570_796_251_296_997, /* 0x3FF921FB, 0x40000000 */
    7.549_789_415_861_596e-8, /* 0x3E74442D, 0x00000000 */
    5.390_302_529_957_765e-15, /* 0x3CF84698, 0x80000000 */
    3.282_003_415_807_913e-22, /* 0x3B78CC51, 0x60000000 */
    1.270_655_753_080_676e-29, /* 0x39F01B83, 0x80000000 */
    1.229_333_089_811_113_3e-36, /* 0x387A2520, 0x40000000 */
    2.733_700_538_164_645_6e-44, /* 0x36E38222, 0x80000000 */
    2.167_416_838_778_048_2e-51, /* 0x3569F31D, 0x00000000 */
];
        ...
        if z == 0. {
            ...
            if j == 0 {
                ...
                for i in (jz + 1)..=(jz + k) {
                    ...
                    i!(f, jx + i, =, i!(IPIO2, jv + i) as Float64);
                    fw = 0f64;
                    for j in 0..=jx {
                        fw += i!(x, j) * i!(f, jx + i - j);
                    }
