...
const PP2: Float32 = -2.8481749818e-02; /* 0xbce9528f */
const PP3: Float32 = -5.7702702470e-03; /* 0xbbbd1489 */
const PP4: Float32 = -2.3763017452e-05; /* 0xb7c756b1 */
const QQ1: Float32 = 3.9791721106e-01; /* 0x3ecbbbce */
const QQ2: Float32 = 6.5022252500e-02; /* 0x3d852a63 */
...
const PA3: Float32 = 3.1834661961e-01; /* 0x3ea2fe54 */
const PA4: Float32 = -1.1089469492e-01; /* 0xbde31cc2 */
const PA5: Float32 = 3.5478305072e-02; /* 0x3d1151b3 */
const PA6: Float32 = -2.1663755178e-03; /* 0xbb0df9c0 */
const QA1: Float32 = 1.0642088205e-01; /* 0x3dd9f331 */
const QA2: Float32 = 5.4039794207e-01; /* 0x3f0a5785 */
const QA3: Float32 = 7.1828655899e-02; /* 0x3d931ae7 */
...
const RA3: Float32 = -6.2375331879e+01; /* 0xc2798057 */
const RA4: Float32 = -1.6239666748e+02; /* 0xc322658c */
const RA5: Float32 = -1.8460508728e+02; /* 0xc3389ae7 */
const RA6: Float32 = -8.1287437439e+01; /* 0xc2a2932b */
const RA7: Float32 = -9.8143291473e+00; /* 0xc11d077e */
const SA1: Float32 = 1.9651271820e+01; /* 0x419d35ce */
const SA2: Float32 = 1.3765776062e+02; /* 0x4309a863 */
const SA3: Float32 = 4.3456588745e+02; /* 0x43d9486f */
const SA4: Float32 = 6.4538726807e+02; /* 0x442158c9 */
const SA5: Float32 = 4.2900814819e+02; /* 0x43d6810b */
...
const RB3: Float32 = -1.6063638306e+02; /* 0xc320a2ea */
const RB4: Float32 = -6.3756646729e+02; /* 0xc41f6441 */
const RB5: Float32 = -1.0250950928e+03; /* 0xc480230b */
const RB6: Float32 = -4.8351919556e+02; /* 0xc3f1c275 */
const SB1: Float32 = 3.0338060379e+01; /* 0x41f2b459 */
const SB2: Float32 = 3.2579251099e+02; /* 0x43a2e571 */
const SB3: Float32 = 1.5367296143e+03; /* 0x44c01759 */
const SB4: Float32 = 3.1998581543e+03; /* 0x4547fdbb */
...
#[export_name = "__l2math_erff"]
#[cfg_attr(all(test, assert_no_panic), no_panic::no_panic)]
pub extern "C" fn erff(x: Float32) -> Float32 {
    let r: Float32;
    let s: Float32;
    let z: Float32;
    let y: Float32;
    ...
    if ix < 0x40c00000 {
        ...
        let x1p_120 = Float32::from_bits(0x03800000);
        y = 1.0 - x1p_120;
    }
...
#[export_name = "__l2math_erfcf"]
pub extern "C" fn erfcf(x: Float32) -> Float32 {
    let r: Float32;
    let s: Float32;
    let z: Float32;
    let y: Float32;
