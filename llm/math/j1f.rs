...
const INVSQRTPI: Float32 = 5.641_896e-1; /* 0x3f106ebb */
const TPI: Float32 = 6.366_197_5e-1; /* 0x3f22f983 */
...
fn common(ix: u32, x: Float32, y1: bool, sign: bool) -> Float32 {
    ...
    let c: Float64 = cosf(x) as Float64;
    cc = s - c;
    if ix < 0x7f000000 {
        ss = -s - c;
...
/* R0/S0 on [0,2] */
const R00: Float32 = -6.25e-2; /* 0xbd800000 */
const R01: Float32 = 1.407_056_7e-3; /* 0x3ab86cfd */
const R02: Float32 = -1.599_556_3e-5; /* 0xb7862e36 */
const R03: Float32 = 4.967_28e-8; /* 0x335557d2 */
const S01: Float32 = 1.915_376e-2; /* 0x3c9ce859 */
const S02: Float32 = 1.859_467_9e-4; /* 0x3942fab6 */
const S03: Float32 = 1.177_184_7e-6; /* 0x359dffc2 */
const S04: Float32 = 5.046_362_4e-9; /* 0x31ad6446 */
const S05: Float32 = 1.235_422_7e-11; /* 0x2d59567e */
...
const U0: [Float32; 5] = [
    -1.960_571e-1, /* 0xbe48c331 */
    5.044_387_3e-2,  /* 0x3d4e9e3c */
    -1.912_568_9e-3, /* 0xbafaaf2a */
    2.352_526e-5,  /* 0x37c5581c */
    -9.190_992e-8, /* 0xb3c56003 */
];
const V0: [Float32; 5] = [
    1.991_673_2e-2, /* 0x3ca3286a */
    2.025_525_8e-4, /* 0x3954644b */
    1.356_088e-6, /* 0x35b602d4 */
    6.227_414_6e-9, /* 0x31d5f8eb */
    1.665_592_5e-11, /* 0x2d9281cf */
];
...
pub fn y1f(x: Float32) -> Float32 {
    ...
    let z: Float32 = x * x;
    let u: Float32 = U0[0] + z * (U0[1] + z * (U0[2] + z * (U0[3] + z * U0[4])));
    let v: Float32 = 1.0 + z * (V0[0] + z * (V0[1] + z * (V0[2] + z * (V0[3] + z * V0[4]))));
