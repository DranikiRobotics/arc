...
const PP2: Float64 = -2.84817495755985104766e-02; /* 0xBF9D2A51, 0xDBD7194F */
const PP3: Float64 = -5.77027029648944159157e-03; /* 0xBF77A291, 0x236668E4 */
const PP4: Float64 = -2.37630166566501626084e-05; /* 0xBEF8EAD6, 0x120016AC */
const QQ1: Float64 = 3.97917223959155352819e-01; /* 0x3FD97779, 0xCDDADC09 */
const QQ2: Float64 = 6.50222499887672944485e-02; /* 0x3FB0A54C, 0x5536CEBA */
...
const PA3: Float64 = 3.18346619901161753674e-01; /* 0x3FD45FCA, 0x805120E4 */
const PA4: Float64 = -1.10894694282396677476e-01; /* 0xBFBC6398, 0x3D3E28EC */
const PA5: Float64 = 3.54783043256182359371e-02; /* 0x3FA22A36, 0x599795EB */
const PA6: Float64 = -2.16637559486879084300e-03; /* 0xBF61BF38, 0x0A96073F */
const QA1: Float64 = 1.06420880400844228286e-01; /* 0x3FBB3E66, 0x18EEE323 */
const QA2: Float64 = 5.40397917702171048937e-01; /* 0x3FE14AF0, 0x92EB6F33 */
const QA3: Float64 = 7.18286544141962662868e-02; /* 0x3FB2635C, 0xD99FE9A7 */
...
const RA3: Float64 = -6.23753324503260060396e+01; /* 0xC04F300A, 0xE4CBA38D */
const RA4: Float64 = -1.62396669462573470355e+02; /* 0xC0644CB1, 0x84282266 */
const RA5: Float64 = -1.84605092906711035994e+02; /* 0xC067135C, 0xEBCCABB2 */
const RA6: Float64 = -8.12874355063065934246e+01; /* 0xC0545265, 0x57E4D2F2 */
const RA7: Float64 = -9.81432934416914548592e+00; /* 0xC023A0EF, 0xC69AC25C */
const SA1: Float64 = 1.96512716674392571292e+01; /* 0x4033A6B9, 0xBD707687 */
const SA2: Float64 = 1.37657754143519042600e+02; /* 0x4061350C, 0x526AE721 */
const SA3: Float64 = 4.34565877475229228821e+02; /* 0x407B290D, 0xD58A1A71 */
const SA4: Float64 = 6.45387271733267880336e+02; /* 0x40842B19, 0x21EC2868 */
const SA5: Float64 = 4.29008140027567833386e+02; /* 0x407AD021, 0x57700314 */
...
const RB3: Float64 = -1.60636384855821916062e+02; /* 0xC064145D, 0x43C5ED98 */
const RB4: Float64 = -6.37566443368389627722e+02; /* 0xC083EC88, 0x1375F228 */
const RB5: Float64 = -1.02509513161107724954e+03; /* 0xC0900461, 0x6A2E5992 */
const RB6: Float64 = -4.83519191608651397019e+02; /* 0xC07E384E, 0x9BDC383F */
const SB1: Float64 = 3.03380607434824582924e+01; /* 0x403E568B, 0x261D5190 */
const SB2: Float64 = 3.25792512996573918826e+02; /* 0x40745CAE, 0x221B9F0A */
const SB3: Float64 = 1.53672958608443695994e+03; /* 0x409802EB, 0x189D5118 */
const SB4: Float64 = 3.19985821950859553908e+03; /* 0x40A8FFB7, 0x688C246A */
...
#[export_name = "__l2math_erf"]
#[cfg_attr(all(test, assert_no_panic), no_panic::no_panic)]
pub extern "C" fn erf(x: Float64) -> Float64 {
    let r: Float64;
    let s: Float64;
    let z: Float64;
    let y: Float64;
    ...
    if ix >= 0x7ff00000 {
        ...
        return 1.0 - 2.0 * (sign as Float64) + 1.0 / x;
    }
    if ix < 0x3feb0000 {
        /* |x| < 0.84375 */
        if ix < 0x3e300000 {
...
#[export_name = "__l2math_erfc"]
pub extern "C" fn erfc(x: Float64) -> Float64 {
    let r: Float64;
    let s: Float64;
    let z: Float64;
    let y: Float64;
    ...
    if ix >= 0x7ff00000 {
        ...
        return 2.0 * (sign as Float64) + 1.0 / x;
    }
    if ix < 0x3feb0000 {
        /* |x| < 0.84375 */
        if ix < 0x3c700000 {
